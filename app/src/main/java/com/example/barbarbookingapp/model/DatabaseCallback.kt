...
fun dataCallback(context: Context) = object : RoomDatabase.Callback() {
    override fun onCreate(db: SupportSQLiteDatabase) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            val appointment2 = Appointment(userId = 2, barberId = 3, appointmentDate = "2023-09-15", appointmentTime = "14:00", serviceCharge = totalServiceCharge2, status = Status.SCHEDULED, paymentMethod = PaymentMethod.CASH)
